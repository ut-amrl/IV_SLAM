...
DEFINE_bool(rectify_images, false, "Set to true, if input images need "
                                   "to be rectified. NOTE: Currently it is assumed that the images are already undistorted, hence distortion parameters are ignored");
...
int main(int argc, char **argv)
{
    ...
    string usage("This program runs stereo ORB-SLAM on KITTI format "
