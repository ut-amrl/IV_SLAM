...
public:
    ...
    // ID of the keyframe (this is an identification among all KeyFrames)
    long unsigned int mnId;
    // ID of the corresponding Frame (this is and identificaiton among all
    // all Frames.)
